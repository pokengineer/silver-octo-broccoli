...
def get_user_agent():
    """
    get a random user agent from an static list.

    ex:
    page = requests.get( myurl, timeout=5, headers = {'User-Agent': get_user_agent() })
    """
    return random.sample(user_agent_list,1)[0]
